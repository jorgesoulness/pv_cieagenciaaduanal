...
$global_proyecto='CIE Logistics';

// Guion bajo seguido del nombre del proyecto
$global_name_session='_cielogisctics';
...
$logo="http://cielogistica.com/dev/assets/img/logos/BAI_logo_c.png";
...
$url_absoluta = 'http://cielogistica.com/';
?>    